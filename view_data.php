		 ...
		 <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">View Student Data</h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="#">View Student Data</a></li>
		...
		<div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
					...
					<a href='index.php'><button aria-label="breadcrumb" class='btn btn-primary mr-2' name='new'>Back</button></a>
                    <br>
					<br>
