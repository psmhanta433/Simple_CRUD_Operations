		...
		<div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
					...
					<a href='add_course.php'><button aria-label="breadcrumb" class='btn btn-primary mr-2' name='new'>Add New</button></a>
                    <br>
					<br>
                        ...
                        <tbody>
							...
							if(mysqli_num_rows($result)>0)
							{
								while($row = mysqli_fetch_assoc($result)) {
									...
									echo "<td><a href='delete_course.php?id=$id'><button class='btn btn-primary mr-2' name='delete'>Delete</button></a></td>";
									echo "</tr>";
