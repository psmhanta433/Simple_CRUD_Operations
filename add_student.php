                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="post" action="">
                      ...
                      <div class="form-group">
                        <label for="exampleInputEmail3">Course</label>
							<select class="form-control form-control-lg" name="course" id="course" placeholder="-select-">
					...
					<div class="form-group">
                      ...
                      <a href="index.php"><button type="submit" class="btn btn-primary mr-2" name="submit"> Submit </button></a>
...
<?php
	...
	$sql1="insert into student(fname,lname,course,year,contact,age,birth,gender) values('$fname','$lname','$course','$year','$contact','$age','$dob','$gender')";
